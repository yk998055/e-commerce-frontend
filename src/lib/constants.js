...
export const FEATURED_TITLE = 'Featured Products';
export const EMPTY_PRODUCTS = 'No products found';
export const EMPTY_CATEGORIES = 'No categories found';
export const LOGIN_TITLE = 'Login';
export const LOGIN_SUBTITLE = 'Sign in to manage your store';
