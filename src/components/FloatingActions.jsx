...
export default function FloatingActions() {
    ...
    return (
        <>
            ...
            >
                <div className="relative">
                    <div className="absolute inset-0 bg-green-500 rounded-full animate-ping opacity-10 group-hover:hidden" />
                    <div className="relative w-14 h-14 bg-[#1e2643] rounded-full flex items-center justify-center shadow-xl group-hover:bg-[#FEE6A9] group-hover:scale-110 transition-all duration-500">
                        <svg className="w-6 h-6 text-[#1e2643]" fill="currentColor" viewBox="0 0 24 24">
